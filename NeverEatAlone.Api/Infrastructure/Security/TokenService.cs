            ...
            JwtSecurityToken jwtSecurityToken = new JwtSecurityToken(
                ...
                payload: new JwtPayload(
                    ...
                    claims: new Claim[]
                    {
                        ...
                        new Claim("IdPhoto", user.IdPhoto),
                    },
        ...
        public ApiUser ValidateToken(string token)
        {
            ...
            if (jwtSecurityToken.ValidFrom <= now && jwtSecurityToken.ValidTo >= now)
            {
                ...
                if (token == compareToken)
                {
                    ...
                    payload.TryGetValue("IdPhoto", out object idPhoto);

                    user = new ApiUser(int.Parse((string)id), (string)lastName, (string)firstName, (string)email, (string)idPhoto);
                }
            }
